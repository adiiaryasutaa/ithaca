...
CREATE TABLE "s3_storage_configs" (
    ...
    "prefix" TEXT NOT NULL DEFAULT 'ithaca',
    "quota_bytes" BIGINT,
    "status" TEXT NOT NULL DEFAULT 'active',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "api_keys" ADD CONSTRAINT "api_keys_target_folder_id_fkey" FOREIGN KEY ("target_folder_id") REFERENCES "folders"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "api_keys" ADD CONSTRAINT "api_keys_target_file_id_fkey" FOREIGN KEY ("target_file_id") REFERENCES "files"("id") ON DELETE SET NULL ON UPDATE CASCADE;
