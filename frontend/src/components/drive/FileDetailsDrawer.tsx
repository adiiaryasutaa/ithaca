  ...
  return (
    <>
      <button
        className={
          open
            ? 'fixed inset-0 z-40 bg-slate-950/30'
            : 'pointer-events-none fixed inset-0 z-40 bg-slate-950/0'
        }
      ...
      >
        <div className="flex items-center justify-between border-b border-border p-5">
          ...
          <Button variant="outline" size="icon" onClick={onClose} aria-label="Close file details">
            <X className="h-5 w-5" />
          </Button>
        </div>
        {file ? (
