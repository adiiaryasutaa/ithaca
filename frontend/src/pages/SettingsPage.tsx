      ...
      <div className="mt-5 grid gap-4">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          <Card className="p-4">
            ...
            <p className="text-[12px] text-muted-foreground">Email and app alerts are active.</p>
          </Card>
          <Card className="p-4">
            <Globe className="h-5 w-5 text-primary" />
            <h2 className="text-[14px] font-bold">Region</h2>
            <p className="text-[12px] text-muted-foreground">Workspace region: local gateway.</p>
          </Card>
        </div>
          ...
          <div className="flex flex-col gap-3.5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-[13px] text-muted-foreground">
                Connect one or more Google Drive accounts. Ithaca will route uploads to account with
                enough space.
              </p>
            </div>
            <Button
